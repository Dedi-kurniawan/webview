...
<head><base href="">
	<meta charset="utf-8" />
	<title>kejaksaan negeri kepahiang</title>
	@laravelPWA
	...
	<link href="{{ asset('template/dist/assets/plugins/custom/prismjs/prismjs.bundle.css') }}" rel="stylesheet" type="text/css" />
...
<!--end::Head-->
<!--begin::Body-->
<body id="kt_body" style="background-image: url({{ asset('template/dist/assets/media/bg/bg-10.jpg') }})" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
	<!--begin::Main-->
	<!--begin::Header Mobile-->
	<div id="kt_header_mobile" class="header-mobile">
		<!--begin::Logo-->
		<a href="#">
			<img alt="Logo" src="{{ asset('template/dist/assets/media/logos/logo-90.png') }}" class="logo-default max-h-30px" />
		{{--  <span class="text-white font-weight-bold">	KEJAKSAAN NEGERI KEPAHIANG </span>  --}}
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="d-flex flex-row flex-column-fluid page">
			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
					...
					<div class="container d-flex align-items-stretch justify-content-between">
						...
						<div class="d-flex align-items-stretch mr-3">
							...
							<div class="header-logo">
								<a href="index.html">
									<img alt="Logo" src="{{ asset('template/dist/assets/media/logos/logo-90.png') }}" class="logo-default max-h-40px" />
									<img alt="Logo" src="{{ asset('template/dist/assets/media/logos/logo-90.png') }}" class="logo-sticky max-h-40px" />
								</a>
							</div>
							<!--end::Header Logo-->
									...
									<ul class="menu-nav">
										<li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here" data-menu-toggle="click" aria-haspopup="true">
											<a href="javascript:;" class="menu-link menu-toggle">
												<span class="menu-text">Selamat Datang</span>
											...
											<div class="menu-submenu menu-submenu-classic menu-submenu-left">
												<ul class="menu-subnav">
													...
													<li class="menu-item menu-item-submenu" data-menu-toggle="hover" aria-haspopup="true">
														...
														<div class="menu-submenu menu-submenu-classic menu-submenu-right" style="top: -135px">
															<ul class="menu-subnav">
																<li class="menu-item" aria-haspopup="true">
				...
				<!--end::Content-->
				<!--begin::Footer-->
				@include('layouts.android.partials.footer')
				<!--end::Footer-->
			</div>
			<!--end::Wrapper-->
		</div>
	...
	{{--  <script src="{{ asset('template/dist/assets/plugins/custom/prismjs/prismjs.bundle.js') }}"></script>  --}}
	<script src="{{ asset('template/dist/assets/js/scripts.bundle.js') }}"></script>
	{{--  <script src="{{ asset('template/dist/assets/js/pages/widgets.js') }}"></script>  --}}
	<!--end::Page Scripts-->
	@stack('script')
</body>
<!--end::Body-->
